...
export const createOrder = (order)=>async(dispatch,getState)=>{
    ...
    try{
       ...
       const {data} = await axios.post("https://myecommerceapplication.herokuapp.com/order/neworder",order,config);
...
export const myOrders = ()=>async(dispatch,getState)=>{
    ...
    try{
       ...
       const {data} = await axios.get("https://myecommerceapplication.herokuapp.com/order/myorders");
...
const {data} = await axios.get(`https://myecommerceapplication.herokuapp.com/order/singleorder/${id}`);
       console.log("data",data);
       dispatch({
...
const {data} = await axios.get(`https://myecommerceapplication.herokuapp.com/order/admin/orders`);
       console.log("data",data);
       dispatch({
...
export const updateOrder = (id,orderData)=>async(dispatch,getState)=>{
    try{
       ...
       const {data} = await axios.put(`https://myecommerceapplication.herokuapp.com/order/admin/orders/${id}`,orderData,config);
...
export const deleteOrder = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`https://myecommerceapplication.herokuapp.com/order/admin/orders/${id}`)
